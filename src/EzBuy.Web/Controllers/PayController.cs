...
namespace EzBuy.Web.Controllers
{
    public class PayController : Controller
    {
        ...
        public PayController(IConfiguration configuration, UserManager<User> userManager)
        {
            ...
            PayGateID = configuration.GetSection("Paygate:PAYGATEID").Value.ToString();
            PayGateKey = configuration.GetSection("Paygate:PAYGATEKEY").Value.ToString();
        }
        ...
        public async Task<JsonResult> GetRequest()
        {
            ...
            // TODO: Here you can add any website url to test, but bear in mind that it will return to this website once payment is completed
            ...
            request.Add("EMAIL",
                HttpContext.User.Identity.IsAuthenticated
                    ? _payment.GetUser(userManager.GetUserAsync(User)).Email
                    : "zhanvidenov59@gmail.com");
